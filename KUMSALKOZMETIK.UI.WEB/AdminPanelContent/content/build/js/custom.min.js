function init_sidebar() {
    var a = function () {
        var tmpr_page_name = window.location.pathname;
        if (tmpr_page_name == '/AdminPanelKategoriler.aspx' || tmpr_page_name == '/taserontakip/AdminPanelKategoriler.aspx')
            $RIGHT_COL.css("min-height", 1250);
        //else if (tmpr_page_name == '/firmaekle.aspx' || tmpr_page_name == '/taserontakip/firmaekle.aspx')
        //    $RIGHT_COL.css("min-height", 1000);
        //else if (tmpr_page_name == '/ihaleekle.aspx' || tmpr_page_name == '/taserontakip/ihaleekle.aspx')
        //    $RIGHT_COL.css("min-height", 1015);
        //else if (tmpr_page_name == '/izintakip.aspx')
        //    $RIGHT_COL.css("min-height", 1038);
        //else
        ...
        $RIGHT_COL.css("min-height", d + 50)
    };

    $SIDEBAR_MENU.find("a").off('click').on("click", function (b) {
    ...
    $MENU_TOGGLE.off('click').on("click", function () {
        ...
        ($SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), a()
    }),
